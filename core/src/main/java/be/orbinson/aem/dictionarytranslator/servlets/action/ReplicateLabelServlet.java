    ...
    protected void doPost(SlingHttpServletRequest request, @NotNull SlingHttpServletResponse response) throws IOException {
        ...
        if (StringUtils.isEmpty(path)) {
            ...
            if (resource != null) {
                ...
                // Specify the paths of the nodes to be published
                String pathToPublish = "/content/dictionaries/i18n/en";

                //Publish only chosen nodes
                DistributionRequest distributionRequest = new SimpleDistributionRequest(DistributionRequestType.ADD, true, pathToPublish);
